...
return ns}},{"./api.json":6}],2:[function(require,module,exports){let validate=require('./_validate')
...
catch(e){callback(e)}}},{"./_origin":4,"./_validate":5}],3:[function(require,module,exports){var bind=require('./_bind')
...
return new Slack}},{"./_bind":1,"./_exec":2}],4:[function(require,module,exports){var origin='https://slack.com'
if("testing"==='testing'){origin='http://localhost:3000'}
if(false){origin=false}
module.exports=origin},{}],5:[function(require,module,exports){var api=require('./api.json')
